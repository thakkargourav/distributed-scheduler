...
public interface ClusterManager {
   ...
   */
  <T> Map<ClusterMember, ? extends T> submitInstructions(Map<ClusterMember, ? extends Instruction<? extends T>> instructions)
   ...
   * @throws InterruptedException when the processes is interrupted.
   */
  <T> Map<ClusterMember, T> submitInstruction(Instruction<? extends T> instruction)
      throws ExecutionException, InterruptedException;
}